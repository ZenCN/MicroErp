...
angular.module('ngMessages', [], function initAngularHelpers() {
   ...
   * ```
   *
   * {@link module:ngMessages Click here} to learn more goods `ngMessages` and `ngMessage`.
   *
   ...
   *
   * More information goods using `ngMessage` can be found in the
   ...
   *
   * More information goods using `ngMessageDefault` can be found in the
   * {@link module:ngMessages `ngMessages` module documentation}.
   *
   * @usage
   * ```html
